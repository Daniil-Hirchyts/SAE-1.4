...
INSERT INTO Villes
VALUES ('Rio de Janeiro', 'Rio de Janeiro, Brésil');
INSERT INTO Villes
VALUES ('Cape Town', 'Le Cap, Afrique du Sud');
INSERT INTO Villes
VALUES ('Moscou', 'Moscou, Russie');
INSERT INTO Villes
VALUES ('Pékin', 'Pékin, Chine');
INSERT INTO Villes
VALUES ('Mexico', 'Mexico DF, Mexique');

-- INSERT INTO Competiteurs
INSERT INTO Competiteurs (num_competiteur, nom, prenom, date_inscription, date_naissance, pays_origine, rang, ville)
VALUES (1, 'Djokovic', 'Novak', TO_DATE('2020-02-01', 'YYYY-MM-DD'), TO_DATE('1981-05-22', 'YYYY-MM-DD'), 'Serbie', 2,
        'Londres');
INSERT INTO Competiteurs
VALUES (2, 'Babage', 'Lambargamber', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1987-05-22', 'YYYY-MM-DD'), 'Serbie',
        2, 'Londres');
INSERT INTO Competiteurs
VALUES (3, 'Federer', 'Roger', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1981-08-08', 'YYYY-MM-DD'), 'Suisse', 3,
        'New York');
INSERT INTO Competiteurs
VALUES (4, 'Zverev', 'Alexander', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1997-04-20', 'YYYY-MM-DD'), 'Allemagne',
        4, 'Tokyo');
INSERT INTO Competiteurs
VALUES (5, 'Thiem', 'Dominic', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1993-09-03', 'YYYY-MM-DD'), 'Autriche', 5,
        'Sydney');
INSERT INTO Competiteurs
VALUES (6, 'Osaka', 'Naomi', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1997-10-16', 'YYYY-MM-DD'), 'Japon', 1,
        'Rio de Janeiro');
INSERT INTO Competiteurs
VALUES (7, 'Kerber', 'Angelique', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1988-01-18', 'YYYY-MM-DD'), 'Allemagne',
        2, 'Cape Town');
INSERT INTO Competiteurs
VALUES (8, 'Serena', 'Venus', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1980-06-17', 'YYYY-MM-DD'), 'États-Unis', 3,
        'Moscou');
INSERT INTO Competiteurs
VALUES (9, 'Barty', 'Ashleigh', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1996-04-24', 'YYYY-MM-DD'), 'Australie',
        4, 'Pékin');
INSERT INTO Competiteurs
VALUES (10, 'Halep', 'Simona', TO_DATE('2020-01-01', 'YYYY-MM-DD'), TO_DATE('1991-09-27', 'YYYY-MM-DD'), 'Roumanie', 5,
        'Mexico');
...
INSERT INTO Visiteurs (num_visiteur, nom, prenom, place_achete, ville)
VALUES (1, 'Dupont', 'Jean', 1, 'Paris');
INSERT INTO Visiteurs
VALUES (2, 'Durand', 'Marie', 2, 'Paris');
INSERT INTO Visiteurs
VALUES (3, 'Martin', 'Luc', 3, 'Londres');
INSERT INTO Visiteurs
VALUES (4, 'Petit', 'Jacques', 4, 'Londres');
INSERT INTO Visiteurs
VALUES (5, 'Lefebvre', 'Sophie', 5, 'New York');
INSERT INTO Visiteurs
VALUES (6, 'Garcia', 'Olivier', 6, 'New York');
INSERT INTO Visiteurs
VALUES (7, 'Johnson', 'Emma', 7, 'Tokyo');
INSERT INTO Visiteurs
VALUES (8, 'Smith', 'David', 8, 'Tokyo');
INSERT INTO Visiteurs
VALUES (9, 'Williams', 'Samantha', 9, 'Sydney');
INSERT INTO Visiteurs
VALUES (10, 'Jones', 'Michael', 10, 'Sydney');
...
--     CONSTRAINT date_naissance CHECK (date_inscription > date_naissance)
    INSERT
INTO Competiteurs (num_competiteur, nom, prenom, date_inscription, date_naissance, pays_origine, rang, ville)
VALUES (1, 'Doe', 'John', '2022-12-14', '2022-12-15', 'France', 1, 'Paris');
...
--     CONSTRAINT place_achete CHECK (place_achete > 0)
INSERT
INTO Visiteurs (num_visiteur, nom, prenom, place_achete, ville)
VALUES (1, 'John', 'Doe', 0, 'New York')
...
--     CONSTRAINT pk_num_epreuve PRIMARY KEY (num_epreuve),
INSERT
INTO Epreuves (num_epreuve, nom, date, heure, num_stade)
...
--     CONSTRAINT fk_num_stade FOREIGN KEY (num_stade) REFERENCES Stades (num_stade),
INSERT
INTO Place (num_visiteur, num_stade, num_place, prix_place, date_achate)
VALUES (1, -1, 1, 5, '2022-12-12')
-- Cette insertion échouera car elle tente d'insérer une valeur qui n'existe pas dans la colonne num_stade, qui est définie comme une clé étrangère.
